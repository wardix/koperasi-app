  ...
  return (
    <VStack gap={3}>
      ...
      <HStack gap={6} vAlign="center">
        <ChartLegendItem color={chartColors.allUsers} label="Total Transaksi" />
        <ChartLegendItem color={chartColors.desktop} label="Simpanan" />
        <ChartLegendItem color={chartColors.mobile} label="Pinjaman" />
      </HStack>
    </VStack>
  );
}
      ...
      content={
        <LayoutContent padding={6}>
          <VStack gap={6}>
            ...
            <VStack gap={6}>
              <HStack hAlign="between" vAlign="center">
                <Heading level={3}>Grafik Pertumbuhan Simpanan</Heading>
                <Button
                  label="Muat Ulang"
                  variant="secondary"
                  size="md"
            ...
            {/* Demographics */}
            <HStack hAlign="between" vAlign="center">
              <Heading level={3}>Demografi Anggota</Heading>
              <Button label="Lihat semua" variant="secondary" size="md" />
            </HStack>
            <Grid columns={{minWidth: 320, repeat: 'fit'}} gap={4}>
            ...
            <Grid columns={{minWidth: 320, repeat: 'fit'}} gap={4}>
              <TableCard
                title="Transaksi Teratas"
                linkLabel="Semua transaksi"
                linkHref="#"
                data={topPagesData}
